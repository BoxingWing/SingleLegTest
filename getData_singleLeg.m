...
pH_Des=pEnd_AngleSegDeg_pHFB_FKPJ_err(2:3,:);
MotorAngle_Des=pEnd_AngleSegDeg_pHFB_FKPJ_err(4:6,:);
pH_FB=pEnd_AngleSegDeg_pHFB_FKPJ_err(7:8,:);
Encoder_Des=pEnd_AngleSegDeg_pHFB_FKPJ_err(9:10,:);
err=pEnd_AngleSegDeg_pHFB_FKPJ_err(11,:);
