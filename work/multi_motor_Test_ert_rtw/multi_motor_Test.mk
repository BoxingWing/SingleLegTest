###########################################################################
## Makefile generated for component 'multi_motor_Test'. 
## 
## Makefile     : multi_motor_Test.mk
## Generated on : Wed Mar 30 17:25:09 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/multi_motor_Test.elf
...
START_DIR                 = $(MATLAB_WORKSPACE)/E/SingleLegTest/work
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/multi_motor_Test.elf
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_CAN_BITRATE=1000000 -DMW_CAN_ALLOWALLMSGS=1
...
DEFINES_STANDARD = -DMODEL=multi_motor_Test -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.c.o : $(START_DIR)/multi_motor_Test_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/multi_motor_Test_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/multi_motor_Test_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
can_motor_encoder.c.o : $(MATLAB_WORKSPACE)/E/SingleLegTest/can_driver/src/can_motor_encoder.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.c.o : $(START_DIR)/multi_motor_Test_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


multi_motor_Test.c.o : $(START_DIR)/multi_motor_Test_ert_rtw/multi_motor_Test.c
	$(CC) $(CFLAGS) -o "$@" "$<"


multi_motor_Test_data.c.o : $(START_DIR)/multi_motor_Test_ert_rtw/multi_motor_Test_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
