...
## Generated on : Mon Mar 28 12:01:38 2022
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/motor_Test.elf
...
%.s.o : $(START_DIR)/motor_Test_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/motor_Test_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.c.o : $(START_DIR)/motor_Test_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


motor_Test.c.o : $(START_DIR)/motor_Test_ert_rtw/motor_Test.c
	$(CC) $(CFLAGS) -o "$@" "$<"


motor_Test_data.c.o : $(START_DIR)/motor_Test_ert_rtw/motor_Test_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
