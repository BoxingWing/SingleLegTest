...
## Generated on : Sat Apr 02 14:44:05 2022
...
%.c.o : $(START_DIR)/encoder_Test_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
%.cpp.o : $(START_DIR)/encoder_Test_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.c.o : $(START_DIR)/encoder_Test_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


encoder_Test.c.o : $(START_DIR)/encoder_Test_ert_rtw/encoder_Test.c
	$(CC) $(CFLAGS) -o "$@" "$<"


encoder_Test_data.c.o : $(START_DIR)/encoder_Test_ert_rtw/encoder_Test_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
